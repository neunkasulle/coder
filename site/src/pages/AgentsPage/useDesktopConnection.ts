...
export function useDesktopConnection({
	...
	const doConnect = useCallback(() => {
		...
		// Create an offscreen container for the RFB canvas if we don't
		// have one yet. This allows the canvas to persist across tab
		// switches without being removed from the DOM.
